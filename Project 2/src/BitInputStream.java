...
public class BitInputStream extends InputStream {
    ...
    /**
     * Creates a BitInputStream reading bits of input from the given stream
     * source.
     *
     * @param input
     *            the input stream to read.
     * @throws IOException
     *             if the input stream cannot be accessed.
     */
     ...
     *            the input stream to read.
     * @param partner
     *            a "partner" bit output stream to watch for EOF.
     * @param bitMode
     *            true to write bits at a time; false to write ASCII characters
     *            (bytes) at a time for debugging.
     * @throws IOException
     ...
     *             if the given input or output stream is null. (The partner can
     *             be null; simply won't partner with any bit output stream in
     *             such a case.)
     */
     ...
     * file for each call to readBit. The alternative is 'byte mode', where a
     * full byte (character) is read from the file each time readBit is called,
    ...
    public int read() throws IOException {
        ...
        if (BitOutputStream.DEBUG) {
            System.out.println("  ** BitInputStream read: " + result + " ("
    ...
    /**
     * Reads and returns some bytes of information from this stream into the
     * given array.
     *
     * @param bytes
     *            array of byte to fill
     ...
     *             if offset + length is past the end of the array.
     */
    @Override
     ...
     * String. You would not normally want to call this method while you're
     * reading bits from a bit input stream; it is provided as a convenience for
     * students doing extra credit functionality in the assignment.
     *
     ...
     * file for each call to readBit (as described under inBitMode). Ignores the
     * caller and always uses 'byte' mode if reading from System.in or if the
     * JVM bitstream.bitmode environment variable is set.
     *
     * @param bitMode
     *            true to use bit mode, false to use byte mode.
     */
